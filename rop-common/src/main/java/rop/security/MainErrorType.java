...
public enum MainErrorType {
	...
	TIMESTAMP_TOKEN_EXPIRE,
	APPKEY_INACTIVE;//APPKEY未激活
    ...
    static {
		...
		errorCodeMap.put(MainErrorType.TIMESTAMP_TOKEN_EXPIRE, "38");
		errorCodeMap.put(MainErrorType.APPKEY_INACTIVE, "39");
    }
