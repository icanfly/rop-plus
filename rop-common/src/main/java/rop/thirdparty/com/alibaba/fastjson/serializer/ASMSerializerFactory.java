...
import static rop.thirdparty.com.alibaba.fastjson.util.ASMUtils.getDesc;
import static rop.thirdparty.com.alibaba.fastjson.util.ASMUtils.getType;
...
import rop.thirdparty.com.alibaba.fastjson.annotation.JSONField;
import rop.thirdparty.com.alibaba.fastjson.annotation.JSONType;
import rop.thirdparty.com.alibaba.fastjson.asm.ClassWriter;
import rop.thirdparty.com.alibaba.fastjson.asm.FieldVisitor;
import rop.thirdparty.com.alibaba.fastjson.asm.Label;
import rop.thirdparty.com.alibaba.fastjson.asm.MethodVisitor;
import rop.thirdparty.com.alibaba.fastjson.asm.Opcodes;
import rop.thirdparty.com.alibaba.fastjson.util.ASMClassLoader;
...
public class ASMSerializerFactory implements Opcodes {
    ...
    public ObjectSerializer createJavaBeanSerializer(Class<?> clazz, Map<String, String> aliasMap) throws Exception {
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, className, "java/lang/Object",
                 new String[] { "rop/thirdparty/com/alibaba/fastjson/serializer/ObjectSerializer" });
        ...
        for (FieldInfo fieldInfo : getters) {
            ...
            mw.visitLdcInsn(rop.thirdparty.com.alibaba.fastjson.asm.Type.getType(getDesc(fieldInfo.getDeclaringClass())));
...

        {
            ...
            mw = cw.visitMethod(ACC_PUBLIC,
                                "write",
                                "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;" +
    ...
    private void generateWriteMethod(Class<?> clazz, MethodVisitor mw, List<FieldInfo> getters, Context context)
...

        {
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, getType(JavaBeanSerializer.class), "writeReference",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;)V");
...

        {
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, context.getClassName(), "writeAsArray",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;)V");
...

        {
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, getType(JSONSerializer.class), "getContext",
                               "()Lrop/thirdparty/com/alibaba/fastjson/serializer/SerialContext;");
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, getType(JSONSerializer.class), "setContext",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/SerialContext;Ljava/lang/Object;Ljava/lang/Object;)V");
        }
        ...
        mw.visitVarInsn(ALOAD, context.var("parent"));
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(JSONSerializer.class), "setContext",
                           "(Lrop/thirdparty/com/alibaba/fastjson/serializer/SerialContext;)V");
    ...
    private void initNature(Class<?> clazz, MethodVisitor mw, Context context) {
        ...
        mw.visitInsn(DUP);
        mw.visitLdcInsn(rop.thirdparty.com.alibaba.fastjson.asm.Type.getType(getDesc(clazz)));
...

        {
            ...
            if (elementType == String.class) {
                ...
                if (elementClass != null && Modifier.isPublic(elementClass.getModifiers())) {
                    mw.visitLdcInsn(rop.thirdparty.com.alibaba.fastjson.asm.Type.getType(getDesc((Class<?>) elementType)));
                    mw.visitMethodInsn(INVOKEVIRTUAL, getType(JSONSerializer.class), "writeWithFieldName",
                                       "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;)V");
                } else {
                    mw.visitMethodInsn(INVOKEVIRTUAL, getType(JSONSerializer.class), "writeWithFieldName",
    ...
    private void _nameApply(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        ...
        mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "applyName",
                           "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;)Z");
        mw.visitJumpInsn(IFEQ, _end);
    }
    ...
    private void _before(MethodVisitor mw, Context context) {
        ...
        mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "writeBefore",
                           "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;C)C");
        mw.visitVarInsn(ISTORE, context.var("seperator"));
    }
    ...
    private void _apply(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (propertyClass == byte.class) {
            ...
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "apply",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Z");
        } else if (propertyClass == short.class) {
            mw.visitVarInsn(ILOAD, context.var("short"));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "apply",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;S)Z");
        } else if (propertyClass == int.class) {
            mw.visitVarInsn(ILOAD, context.var("int"));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "apply",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;I)Z");
        } else if (propertyClass == char.class) {
            mw.visitVarInsn(ILOAD, context.var("char"));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "apply",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;C)Z");
        } else if (propertyClass == long.class) {
            mw.visitVarInsn(LLOAD, context.var("long", 2));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "apply",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;J)Z");
        } else if (propertyClass == float.class) {
            mw.visitVarInsn(FLOAD, context.var("float"));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "apply",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;F)Z");
        } else if (propertyClass == double.class) {
            mw.visitVarInsn(DLOAD, context.var("double", 2));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "apply",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;D)Z");
        } else if (propertyClass == boolean.class) {
            mw.visitVarInsn(ILOAD, context.var("boolean"));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "apply",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Z");
            ...
            mw.visitVarInsn(ALOAD, context.var("decimal"));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "apply",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Z");
        } else if (propertyClass == String.class) {
            mw.visitVarInsn(ALOAD, context.var("string"));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "apply",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Z");
    ...
    private void _processValue(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKESTATIC,
                           ...
                           "processValue",
                           "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;");
    ...
    private void _processKey(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (propertyClass == byte.class) {
            ...
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "processKey",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Ljava/lang/String;");
        } else if (propertyClass == short.class) {
            mw.visitVarInsn(ILOAD, context.var("short"));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "processKey",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;S)Ljava/lang/String;");
        } else if (propertyClass == int.class) {
            mw.visitVarInsn(ILOAD, context.var("int"));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "processKey",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;I)Ljava/lang/String;");
        } else if (propertyClass == char.class) {
            mw.visitVarInsn(ILOAD, context.var("char"));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "processKey",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;C)Ljava/lang/String;");
        } else if (propertyClass == long.class) {
            mw.visitVarInsn(LLOAD, context.var("long", 2));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "processKey",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;J)Ljava/lang/String;");
        } else if (propertyClass == float.class) {
            mw.visitVarInsn(FLOAD, context.var("float"));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "processKey",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;F)Ljava/lang/String;");
        } else if (propertyClass == double.class) {
            mw.visitVarInsn(DLOAD, context.var("double", 2));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "processKey",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;D)Ljava/lang/String;");
        } else if (propertyClass == boolean.class) {
            mw.visitVarInsn(ILOAD, context.var("boolean"));
            mw.visitMethodInsn(INVOKESTATIC, getType(FilterUtils.class), "processKey",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Z)Ljava/lang/String;");
        } else if (propertyClass == BigDecimal.class) {
            mw.visitVarInsn(ALOAD, context.var("decimal"));
            mw.visitMethodInsn(INVOKESTATIC,
                               getType(FilterUtils.class),
                               "processKey",
                               "(Lrop/thirdparty/com/alibaba/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;");
        } else if (propertyClass == String.class) {
            mw.visitVarInsn(ALOAD, context.var("string"));
            mw.visitMethodInsn(INVOKESTATIC,
                               getType(FilterUtils.class),
