...
public interface ListenableFuture<V> extends Future<V> {
   ...
   * rop.thirdparty.com.google.common.util.concurrent.Futures}. For a simplified but general
   * listener interface, see {@link
   * rop.thirdparty.com.google.common.util.concurrent.Futures#addCallback addCallback()}.
   *
