...
public class ServiceMethodDefinition {
	 ...
	 * 默认分组标识
	 */
	public static final String DEFAULT_GROUP_TITLE = "DEFAULT_GROUP";
	 ...
	 * 方法参数的注解列表
	 */
	private Annotation[][] methodParameterAnnotaions = new Annotation[][] { };
	...
	public Annotation[][] getMethodParameterAnnotaions() {
		return methodParameterAnnotaions;
	}

	public void setMethodParameterAnnotaions(Annotation[][] methodParameterAnnotaions) {
		this.methodParameterAnnotaions = methodParameterAnnotaions;
	}
}
