...
import rop.security.InvokeTimesController;
...
/**
 * <pre>
 *      ROP的服务路由器，服务方法必须位于@Controller的类中，服务方法使用{@link rop.annotation.ServiceMethod}注解，有两个合法的方法签名方式：
 * 签名方式1：有入参，且参数必须实现{@link rop.request.ServiceRequest}接口，返回参数为{@link rop.response.RopResponse}
 *   <code>
 *    @ServiceMethod("method1")
 *    RopResponse handleMethod1(ServiceRequest ropRequest){
 *        ...
 *    }
 *   </code>
 * 签名方式2：无入参，返回参数为{@link rop.response.RopResponse}
 *   <code>
 *    @ServiceMethod("method1")
...
public interface ServiceRouter {
    ...
    /**
     * 设置{@link rop.security.SecurityManager}
     *
     * @param securityManager
     */
    void setSecurityManager(rop.security.SecurityManager securityManager);
	...
	/*
	 * 设置时间戳误差容忍度
	 * @param timestampTolerance
	 */
	void setTimestampTolerance(long timestampTolerance);
}