...
public class DefaultSecurityManager implements SecurityManager {
    ...
    static {
		...
		//add by luopeng 2014.04.24
		//OVal验证框架错误码映射
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.Assert",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.AssertFalse",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.AssertNull",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.AssertTrue",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.AssertURL",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.CheckWith",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.DateRange",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.Email",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.EqualToField",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.Future",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.HasSubstring",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.InstanceOf",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.InstanceOfAny",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.Length",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.MatchPattern",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.Max",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.MaxLength",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.MaxSize",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.MemberOf",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.Min",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.MinLength",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.MinSize",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.NoSelfReference",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.NotBlank",SubErrorType.ISV_MISSING_PARAMETER);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.NotEmpty",SubErrorType.ISV_MISSING_PARAMETER);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.NotEqual",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.NotEqualToField",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.NotMatchPattern",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.NotMemberOf",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.NotNegative",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.NotNull",SubErrorType.ISV_MISSING_PARAMETER);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.Past",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.Range",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.Size",SubErrorType.ISV_INVALID_PARAMETE);
		INVALIDE_CONSTRAINT_SUBERROR_MAPPINGS.put("net.sf.oval.constraint.ValidateWithMethod",SubErrorType.ISV_INVALID_PARAMETE);
    ...
    public MainError validateSystemParameters(RopRequestContext rrc) {
		...
		if(ropContext.getTimestampTolerance() > 0 && Math.abs(currTime - rrc.getTimestamp())/1000 > ropContext.getTimestampTolerance()){
			return MainErrors.getError(MainErrorType.TIMESTAMP_TOKEN_EXPIRE, rrc.getLocale());
		}
		...
		AppkeyResult appkeyResult = appSecretManager.isValidAppKey(rrc.getAppKey(),rrc);
		rrc.setAppkeyUserId(appkeyResult.getAppkeyUserId());
		if(!appkeyResult.isSuccess()){
			if (AppkeyResult.APPKEY_INACTIVE.equals(appkeyResult.getResultCode())) {
				return MainErrors.getError(MainErrorType.APPKEY_INACTIVE, rrc.getLocale());
			}else{
    ...
    private MainError checkUploadFile(RopRequestContext rrctx) {
        ...
        if (serviceMethodHandler != null && serviceMethodHandler.hasUploadFiles()) {
            ...
            for (String fileFieldName : fileFieldNames) {
                String paramValue = rrctx.getBodyParameter(fileFieldName);
                if (paramValue != null) {
    ...
    private MainError checkServiceAccessAllow(RopRequestContext smc) {
        if (!getServiceAccessController().isAppGranted(smc.getAppKey(), smc.getMethod(), smc.getVersion())) {
            ...
            SubError subError = SubErrors.getSubError(SubErrorType.ISV_INVALID_PERMISSION.value(),
                    ...
                    smc.getLocale(),"checkServiceAccessAllow failed.");
            ...
            if (!getServiceAccessController().isUserGranted(smc.getSession(), smc.getMethod(), smc.getVersion())) {
                ...
                SubError subError = SubErrors.getSubError(SubErrorType.ISV_INVALID_PERMISSION.value(),
                        SubErrorType.ISV_INVALID_PERMISSION.value(),
                        smc.getLocale(),"checkServiceAccessAllow failed. user forbidden");
                mainError.addSubError(subError);
                if (mainError != null && logger.isErrorEnabled()) {
        ...
        if (ctx.isSignEnable()) {
            if (!ctx.getServiceMethodDefinition().isIgnoreSign()) {
                if (ctx.getSign() == null) {
                    ...
                    AppkeyResult appkeyResult = getAppSecretManager().getSecret(ctx.getAppKey(),ctx);
                    if (appkeyResult == null || appkeyResult.getData() == null) {
                        throw new RopException("无法获取" + ctx.getAppKey() + "对应的密钥");
                    }else if(!appkeyResult.isSuccess()) {
						if (AppkeyResult.APPKEY_INACTIVE.equals(appkeyResult.getResultCode())) {
							return MainErrors.getError(MainErrorType.APPKEY_INACTIVE, ctx.getLocale());
						} else {
							throw new RopException("无法获取" + ctx.getAppKey() + "对应的密钥");
						}
					}
